    ...
    return (
        <section className='moduloUnoContainer'>
            ...
            <div className='videoyoutube'>
                <iframe width="570" height="325" src="https://www.youtube.com/embed/Wn59EvTnnig?si=a9TyoDC9jgHqLWuu&autoplay=1&modestbranding=1&mute=1" title="Instituto Privado de Merlo" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
        </section>
    )
}
